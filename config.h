...
#define RADIO_TX                p13//p13 /* TODO: specify your setup's Serial TX pin connected to the XBee module DIN pin */
#define RADIO_RX                p14//p14 /* TODO: specify your setup's Serial RX pin connected to the XBee module DOUT pin */
...
#define RADIO_RESET             p12 /* TODO: specify your setup's GPIO (output) connected to the XBee module's reset pin */
#define RADIO_SLEEP_REQ         p22 /* TODO: specify your setup's GPIO (output) connected to the XBee module's SLEEP_RQ pin */
#define RADIO_ON_SLEEP          p21 /* TODO: specify your setup's GPIO (input) connected to the XBee module's ON_SLEEP pin */
